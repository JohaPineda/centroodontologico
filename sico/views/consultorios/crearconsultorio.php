...
<div style="width: 80%; margin: 15px auto 0;">     
    <h1 class="titulossecciones">Crear Consultorio</h1>               
<?php $view->startForm("index.php?controlador=Consultorios&accion=crearconsultorios", "formularioservicios"); ?>     
      <table style="font-size: 12px" align="center" border="0" width="100%">    
        ...
        <tr><td style="padding-left: 10px" width="30%" bgcolor="#E4E4E4">Telefono
            </td><td align="center" width="15%" height="40px" bgcolor="#F0F0F0">&nbsp;
                <?php $view->input("telefono",
                        "numeric", 
                        "Telefono",
                        array("text" => "numeric", "minsize" => 7),
                        array("size" => "30%", "maxlength" => "10", "id" => "telefono")); ?>
            </td>
      </table>  
        <p class="nuevo" style="text-align: center; margin-top: 20px;">           
            <input type="submit" value="Crear consultorio" style="font-size: 20px"/> 
        </p> 
<?php $view->endForm(); ?>
</div>     
