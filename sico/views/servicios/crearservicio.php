...
<div style="width: 80%; margin: 15px auto 0;">   
    <h1 class="titulossecciones">Crear Servicio</h1>              
    <?php $view->startForm("index.php?controlador=Servicios&accion=crearservicios", "formularioservicios"); ?>     
        ...
        <tr><td style="padding-left: 10px" width="30%" bgcolor="#E4E4E4">Valor</td>
            <td align="center" width="15%" height="40px" bgcolor="#F0F0F0">&nbsp;
                ...
                $view->input("valor",
                        ...
                        array("size" => "30%", "maxlength" => "10"));
                ?>             
            </td>
        <tr><td style="padding-left: 10px" width="30%" bgcolor="#E4E4E4">Descripcion</td>
            <td align="center" width="15%" height="40px" bgcolor="#F0F0F0">&nbsp;
                <textarea name="descripcion" cols="23" rows="7"></textarea></td>           
    </table>  
    <p class="nuevo" style="text-align: center; margin-top: 20px;">           
        <input type="submit" value="Crear servicio" style="font-size: 22px"/> 
    </p> 
<?php $view->endForm(); ?>
</div>     
