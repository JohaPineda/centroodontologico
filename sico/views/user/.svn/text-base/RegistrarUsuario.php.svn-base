...
?>
<form method="POST" action="index.php?controlador=RegistrarUsuario&accion=insertarpaciente" id="formularioPaciente">
<table style="font-size: 12px" align="center" border="0" width="80%">
    ...
    <tr><td style="padding-left: 10px" width="30%" bgcolor="#E4E4E4"><?php $doc->texto('CEDULA') ?>(*)</td><td align="center" width="15%" height="40px" bgcolor="#F0F0F0">&nbsp;<?php $view->input("cedula", "numeric", "Cedula", array("norepeat" => "val3","required" => true, "text" => "numeric", "minsize" => "6"), array("size" => "30%", "maxlength" => "12")); ?>            
