...
<div style="width: 90%; margin: 0 auto;">
    <h1 class="titulossecciones">Especialistas:</h1>
    <div style="margin: 0px 0 5px;">
        <a class="opcionbutton" id="creatett" 
           style="float: right" href="index.php?controlador=Usuarios&accion=addEspecialista">
            + Nuevo Especialista
        </a>
        ...
        <table id="mytable" border="0" cellspacing="0" cellpadding="0">
            <thead>
                <tr>
                    ...
                    <th class="norm" style="cursor: pointer">Consultorio</th>  
                    ...
                    foreach ($especialistas as $value) {
                        ...
                        <tr id="esp<?php echo $value['id']; ?>">                            
                            ...
                            <td class="<?php echo $default2; ?>" style="width: 49px;text-align: center; padding-left: 6px;">                               
                                ...
                                <a class="various3" href="index.php?controlador=Usuarios&accion=editarespecialista&idespecialista=<?php echo $value['id']; ?>">
                            ...
                            <td class="<?php echo $default2; ?>" style="width: 65px;text-align: center; padding-left: 6px;">  
                                <?php if ($value['citas'] == 0) { ?>
                                    <a id="dell<?php echo sha1($value['id']); ?>" 
                                       ...
                                       tar="index.php?controlador=Usuarios&accion=deleteMedico" 
    ...
    <div style="display: none">
        <div id="contentcall">
            <div style="text-align: center; margin-bottom: 12px;margin-top: 40px;padding-left: 20px;padding-right: 20px; font-size: 12px">
                Esta seguro de eliminar el especialista <strong id="nameofdelete"></strong>?
            </div>
...
<script>
    ...
    function createdata(id,nombre,consultorio,servicio,idcode,idverify){    
        var addId = $('#mytable').dataTable().fnAddData([            
            ...
            consultorio,  
            servicio,   
            "<a class='various3"+id+"' href='index.php?controlador=Usuarios&accion=editarespecialista&idespecialista="+id+"' objectedit='"+id+"' ><img src='images/list.png' width='15px' height='15px'/></a>",
            "<a id='dell"+idcode+"' callback='"+nombre+"' tar='index.php?controlador=Usuarios&accion=deleteMedico' href='#' verify='"+idverify+"' onclick='confirmfunction($(this).attr(\"id\"))'><img src='images/delete.gif' class='delete'/></a>"]            
    );           
        var theNode = $('#mytable').dataTable().fnSettings().aoData[addId[0]].nTr;
        theNode.setAttribute('id',"esp"+id);  
        ...
        oTable=$('#mytable').dataTable( {
            "fnCreatedRow": function( nRow, aData, iDataIndex ) {                
                ...
                if($('td:eq(3) a', nRow).attr('objectedit')){
                    $('td:eq(0)', nRow).attr('id','nome'+$('td:eq(3) a', nRow).attr('objectedit'));
                    $('td:eq(1)', nRow).attr('id','cons'+$('td:eq(3) a', nRow).attr('objectedit'));
                    $('td:eq(2)', nRow).attr('id','serv'+$('td:eq(3) a', nRow).attr('objectedit'));
